...
FastImage = (function() {
  ...
  FastImage.fastimage = function(uri, callback) {
    return new FastImage(uri, callback).fetchDimensions();
  };
  ...
  FastImage.prototype.fetchDimensions = function() {
    return this.fetchPacket(this.uri);
  };
  ...
  FastImage.prototype.fetchPacket = function(uri) {
    ...
    request(uri).pipe(through(function(buffer) {
      if ( once ) {
        this.emit('end');
      } else {
        once = true;
